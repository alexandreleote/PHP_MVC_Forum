...
-- Listage des données de la table forum_alexandre.category : ~5 rows (environ)
...
-- Listage des données de la table forum_alexandre.message : ~0 rows (environ)
DELETE FROM `message`;
...
-- Listage des données de la table forum_alexandre.topic : ~0 rows (environ)
DELETE FROM `topic`;
